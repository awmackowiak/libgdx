...
import pl.magines.zombiebird.gameobjects.Grass;
import pl.magines.zombiebird.gameobjects.Pipe;
...
//        Gdx.app.log("GameRenderer", "renderer");
        ...
        if(myWorld.isReady()){
            ...
            if(myWorld.isGameOver() || myWorld.isHighScore()) {
                if(myWorld.isGameOver()){
                    ...
                    AssetLoader.shadow.draw(batcher, "High Score:", 23, 103);
                    AssetLoader.font.draw(batcher, "High Score:", 22, 102);
